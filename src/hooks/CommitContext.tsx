...
export const CommitStateProvider: FunctionComponent = ({ children }) => {
  ...
  return (
    <CommitContext.Provider value={{ error, commits, since, setSince, until, setUntil, numberOfPages, currentPage, setCurrentPage, fetching, selectedCommit, setSelectedCommit }}>
      {children}
