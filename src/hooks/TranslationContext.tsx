...
export const TranslationsProvider: FunctionComponent = ({ children }) => {
  ...
  return <TranslationContext.Provider value={{ setLanguage, language, translate: TranslationService.translate.bind(TranslationService) }}>{children}</TranslationContext.Provider>
}
