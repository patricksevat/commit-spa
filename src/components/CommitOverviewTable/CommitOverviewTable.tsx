import { Paper, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Toolbar } from '@material-ui/core'
...
export const CommitOverviewTable = () => {
  ...
  return (
    <Paper data-test="commit-overview-table">
      ...
      <TableContainer id="commit-overview-table">
        <Table>
          <TableHead>
            <TableRow>
              <TableCell className="commit-overview-table__header-cell" data-test="message-translated">
                {translate('message')}
              </TableCell>
              <TableCell className="commit-overview-table__header-cell">{translate('date')}</TableCell>
              <TableCell className="commit-overview-table__header-cell">{translate('author')}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {commits.map((commit) => (
      ...
      <TablePagination rowsPerPageOptions={[10]} component="div" count={numberOfPages || 1} rowsPerPage={10} page={currentPage} onPageChange={handleChangePage} />
    </Paper>
  )
}
